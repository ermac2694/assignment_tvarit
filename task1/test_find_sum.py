...
class TestSum(unittest.TestCase):
    ...
    def test_sum_summation(self):
        self.assertEqual(calculate_sum([1, 2, 3]), 6, "Should be 6")

    def test_sum_strc(self):
        self.assertEqual(calculate_sum([1, 2, 'a']), "All inputs must be numeric", "String found")
    
    def test_sum_strac(self):
        self.assertEqual(calculate_sum(['a', 2, 4]), "All inputs must be numeric", "String found")
